...
public class OportunidadeControllerTest {
    ...
    public void deveAtualizarOportunidades() throws Exception {
        ...
        .andExpect(MockMvcResultMatchers.status().isOk())
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.descricao").value("Descrição da oportunidade Atualizada"))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.dataPublicacao").value(LocalDate.now().toString()))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.dataExpiracao").value(LocalDate.now().plusDays(30).toString()))
    ...
    public void deveListarOportunidades() throws Exception {
        ...
        Mockito.when(oportunidadeService.listarTodasOportunidadesOrdenadasPorData()).thenReturn(oportunidadesMock);
        ...
        mvc.perform(request)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].descricao").value("Descrição da oportunidade"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].dataPublicacao").value(LocalDate.now().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].dataExpiracao").value(LocalDate.now().plusDays(30).toString()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].descricao").value("Descrição da oportunidade"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].dataPublicacao").value(LocalDate.now().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].dataExpiracao").value(LocalDate.now().plusDays(30).toString()))
    ...
    public void deveListarOportunidadesAprovadas() throws Exception {
        ...
        List<Oportunidade> oportunidadesMock = Arrays.asList(oportunidade1, oportunidade2);
        Mockito.when(oportunidadeService.listarOportunidadesAprovadasOrdenadasPorData()).thenReturn(oportunidadesMock);
