...
public class CursoControllerTest {
        ...
        public void deveListarCursos() throws Exception {
                ...
                mvc.perform(request)
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$[0].nivel")
                                                .value(retornoServLista.get(0).getNivel()))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$[1].nivel")
                                                .value(retornoServLista.get(1).getNivel()));
        }
        ...
        public void deveListarEgressosPorCurso() throws Exception {
                ...
                mvc.perform(request)
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$[1].nomeEgresso")
                                                .value(egresso2.getNome()));
        }
        ...
        public void deveListarQuantidadeDeEgressosPorCurso() throws Exception {
                ...
                Mockito.when(cursoService.listarQuantidadeDeEgressosPorCurso(Mockito.any(Curso.class)))
                                .thenReturn(quantidadeEgressosCurso);
